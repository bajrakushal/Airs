<?php
  ...
  $que = "SELECT * FROM product WHERE category_id='2'";
...
<section style="padding: 50px 50px;">
  <div class="containers">
    <div class="ars">
      <h2>- Collectibles -</h2>
      <p>Collectibles are treasure troves of stories. From their history to cultural significance, to why they were used or how they were created, the story behind an old collectible makes it relevant even after decades and centuries. Our unique range of collectibles is a connoisseur's delight. We reliably source the most prized pieces that can become your story to share, a part of your heirloom. </p>
    </div>
  </div>
</section>
