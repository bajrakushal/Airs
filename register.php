<?php include('php file/connection.php')?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<section style="padding-top: 15px;">
  ...
  <div class="tops">
    <div class="brand">
      <a href="index.html"><h2>Airs Arts</h2></a>
    </div>
    <div class="brands">
      <form class="sear">
...
<article>
  <div class="containers">
    <div class="login">
      <div class="logins">
        <div class="flex">
          <div class="flex1"><h2 class="up">Sign Up</h2></div>
          <div class="flex2"><a href="login.php" class="down">Login</a></div>
        </div>
        <form class="logns" action="register.php" method="POST">
          <?php include('php file/errors.php')?>
