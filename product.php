...
<section style="padding: 50px 50px;">
  <div class="containers">
    <div class="ars">
      <h2>- Fine Art -</h2>
      <p>Art has the ability to transform a space and define its' character. At Airs Arts, we house an impressive selection of fine art to cater to different sensibilities and tastes. From paintings by established and emerging global artists, to signed limited edition serigraphs of masters that are investment worthy, traditional art forms like Pichwai, Tanjore and Miniature to fine art photography and sculpture, we carry it all. You can discover our extensive fine art collection by browsing through our different collections below. </p>
    </div>
  </div>
</section>
...
<section style="padding-bottom: 50px; ">
  <div class="containers">
    <div class="arts">
       ...
       <div class="discov">
        <a href="#" class="imgs">
          <img src="image/sun.jpg" alt="art" class="ar" style="width: 100%; height: auto;">
